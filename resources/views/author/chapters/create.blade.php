...
<div class="container-fluid">
    <div class="card p-4">
        <div class="d-flex justify-content-between">
            <div class="mb-3">
                <h4><i class="fas fa-plus-circle mr-2"></i>Create Chapter</h4>
            </div>
            <div class=" mb-3">
                {{-- <button class="btn btn-primary" data-target="#createChapter" data-toggle="modal"><i class="fas fa-plus-circle mr-2"></i>Create</button> --}}
                <a href="{{ url('/author/novels/view/'.$id) }}" class="btn btn-outline-pink"><i class="fas fa-arrow-left mr-2"></i>Back</a>
            </div>
        </div>

        <div>
            <form action="{{ url('/author/novels/chapters/create') }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="book_id" id="book_id" class="form-select">
                                ...
                                @foreach ($books as $book)
                                    <option value="{{ $book->id }}" {{ $id == $book->id ? 'selected' : '' }}>
                                        {{ $book->title }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="mb-3 text-end">
                    ...
                    <button type="submit" class="btn btn-pink"><i class="fas fa-plus-circle mr-2"></i>Create</button>
                </div>
            </form>
        </div>
    </div>
