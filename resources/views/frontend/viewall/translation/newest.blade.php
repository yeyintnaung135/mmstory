...
<div class="container-fluid" style=" overflow: hidden;" id="main">
    <div class="" style="overflow: hidden;">
        <div class="nav-container">
            ...
            <a href="{{ url('/translation') }}" class="nav-box d-block text-decoration-none" style="box-shadow: 2px 3px 4px #fc0865; border:1px solid #fc0865">
                <div class="nav-content">
        ...
        <div class="d-flex justify-content-end">
            ...
            <div class="dropdown-center sortBy mt-1 ms-2">
                ...
                <ul class="dropdown-menu sort-menu">
                    <li><a class="dropdown-item" href="{{ url('/translation') }}" id="all">All</a></li>
                    <li><a class="dropdown-item" href="{{ url('/translation-popular') }}" id="popular">Popular</a></li>
                    <li><a class="dropdown-item" href="{{ url('/translation-complete') }}" id="complete">Completed</a></li>
                    <li><a class="dropdown-item" href="{{ url('/translation-newest') }}" id="newest">Newest</a></li>
                    <li><a class="dropdown-item" href="{{ url('/translation-oldest') }}" id="oldest">Oldest</a></li>
                </ul>
            </div>
        </div>
    </div>
