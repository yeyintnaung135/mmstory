...
<div class="container-fluid" style=" overflow: hidden;" id="main">
    <div class="" style="overflow: hidden;">
        <div class="nav-container">
            ...
            <a href="{{ url('/own-creation') }}" class="nav-box d-block text-decoration-none" style="box-shadow: 2px 3px 4px #fc0865; border:1px solid #fc0865">
                <div class="nav-content">
    ...
    <div class="d-flex justify-content-between">
        <h1 class="title">Own Creation</h1>
        <div class="d-flex justify-content-end">
            ...
            <div class="dropdown-center sortBy mt-1 ms-2">
                ...
                <ul class="dropdown-menu sort-menu">
                    <li><a class="dropdown-item" href="{{ url('/own-creation') }}" id="all">All</a></li>
                    <li><a class="dropdown-item" href="{{ url('/own-creation-popular') }}" id="popular">Popular</a></li>
                    <li><a class="dropdown-item" href="{{ url('/own-creation-complete') }}" id="complete">Completed</a></li>
                    <li><a class="dropdown-item" href="{{ url('/own-creation-newest') }}" id="newest">Newest</a></li>
                    <li><a class="dropdown-item" href="{{ url('/own-creation-oldest') }}" id="oldest">Oldest</a></li>
                </ul>
            </div>
        </div>
    </div>
