...
<div class="container-fluid">
    <div class="card p-4">
        <div class="d-flex justify-content-between">
            <div class="mb-3">
                <h4><i class="fas fa-file mr-2"></i>Edit Chapter</h4>
            </div>
            <div class=" mb-3">
                {{-- <button class="btn btn-primary" data-target="#createChapter" data-toggle="modal"><i class="fas fa-plus-circle mr-2"></i>Create</button> --}}
                <a href="{{ url('/admin/book/view/'.$chapter->book_id) }}" class="btn btn-outline-primary"><i class="fas fa-arrow-left mr-2"></i>Back</a>
            </div>
        </div>

        <div>
            <form action="{{ url('/admin/chapter/edit/'.$chapter->id) }}" method="post">
                @csrf
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="book_id" id="" class="form-select">
                                ...
                                <option value="{{ $book->id }}"
                                    ...
                                    @selected(true)
                                    @endif
                                    ><i class="fas fa-book mr-2"></i>{{ $book->title }}</option>
                                @endforeach
                            </select>
                            @error('book_id')
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" name="full_text" id="full_text" cols="30" rows="10">{{ $chapter->full_text }}</textarea>
                    @error('full_text')
                ...
                <div class="d-flex justify-content-between">
                    <div class="mb-3">
                        {{-- <a href="{{ url('/admin/chapter/') }}" class="btn btn-outline-secondary"><i class="fas fa-arrow-left mr-2"></i>Back</a> --}}
                    </div>
                    <div class="mb-3">
