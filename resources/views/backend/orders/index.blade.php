                ...
                <div class="d-flex justify-content-end">
                    <div>
                        ...
                        <div class="d-none report">
                            ...
                            {{-- <div class="text-right">
                                <label for="monthly" class="form-label mr-3">
                                    <input type="radio" name="report" id="monthly"> Author
                                </label>
                                <label for="overall" class="form-label">
                                    <input type="radio" name="report" id="overall"> Overall
                                </label>
                            </div>
                            <div class="text-right overall mb-2 d-none">
                                <a class="btn btn-sm btn-outline-primary" href="{{ url('/overall_orders') }}"><i class="fas fa-file-download mr-2"></i>Overall Report</a>
                                <form class="mb-2 text-left" action="{{ url('/date_between_report') }}" method="GET">
                                    @csrf
                                    <div class="d-flex">
                                        <div class="mr-3">
                                ...
                                <form class="mt-2" action="{{ url('/monthly_report') }}" method="GET">
                                    @csrf
                                    <div class="d-flex">
                                        <div class="mr-3">
                                            <small class="d-block text-primary fw-bold">Monthly</small>
                                        </div>
                                        <select name="month" id="" class="form-select form-select-sm">
                                        ...
                                        <select name="year" id="" class="form-select form-select-sm">
                                            <option value="">Choose Year</option>
                                            @foreach ($years as $year)
                                            <option value="{{ $year->year }}">{{ $year->year }}</option>
                                            @endforeach
                                        </select>
                                        <button type="submit" class="btn btn-sm btn-primary"><i class="fas fa-magnifying-glass"></i></button>
                                    </div>
                                </form>
                                <form class="mt-2" action="{{ url('/yearly_report') }}" method="GET">
                                    @csrf
                                    <div class="d-flex">
                                        <div class="mr-3">
                                            <small class="d-block text-primary fw-bold">Yearly</small>
                                        </div>
                                        <select name="year" id="" class="form-select form-select-sm">
                                            <option value="">Choose Year</option>
                                            @foreach ($years as $year)
                            ...
                            <div class="d-none monthly">
                                ...
                                <form class="mb-2" action="{{ url('/author_monthly_report') }}" method="GET">
                                    @csrf
                                    <div class="d-flex">
                                        <select name="user_id" id="" class="form-select form-select-sm">
                                            <option value="">Choose Author</option>
                                ...
                                <form class="mb-2" action="{{ url('/author_yearly_report') }}" method="GET">
                                    @csrf
                                    <div class="d-flex">
                                        <select name="user_id" id="" class="form-select form-select-sm">
                                            <option value="">Choose Author</option>
                        ...
                        <div class="d-none filter">
                            ...
                            {{-- <div class="text-end">
                                <label for="author" class="form-label mr-2">
                                    <input type="radio" name="filter" id="author"> Author
                                </label>
                                <label for="month" class="form-label mr-2">
                                    <input type="radio" name="filter" id="month"> Overall
                                </label>
                            </div> --}}
                            {{-- <div class="authorfilter d-none">
                                <form class="mb-2" action="{{ url('/admin/orders/authorDateBetween') }}" method="POST">
                                    @csrf
                                    <div class="d-flex justify-content-between">
                                        <div>
                                ...
                                <form class="" action="{{ url('/admin/orders/authorMonthly') }}" method="POST">
                                    @csrf
                                    <div class="d-flex">
                                        <select name="user_id" id="" class="form-select form-select-sm">
                                            <option value="">Choose Author</option>
                                ...
                                <form class="mt-2" action="{{ url('/admin/orders/authorYearly') }}" method="POST">
                                    @csrf
                                    <div class="d-flex">
                                        <select name="user_id" id="" class="form-select form-select-sm">
                                            <option value="">Choose Author</option>
                            ...
                            {{-- <div class="monthfilter d-none">
                                ...
                                <form class="mb-2" action="{{ url('/admin/orders/monthly') }}" method="POST">
                                    @csrf
                                    <div class="d-flex">
                                        <div class="mr-3">
                                ...
                                <form class="" action="{{ url('/admin/orders/yearly') }}" method="POST">
                                    @csrf
                                    <div class="d-flex">
                                        <div class="mr-3">
                                            <small class=" text-primary fw-bold">Yearly</small>
                                        </div>
                                        <select name="year" id="" class="form-select form-select-sm">
                                            <option value="">Choose Year</option>
                                            @foreach ($years as $year)
